...
//
//  Created by Sydnie Nguyen on 11/27/20.
//
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
/*
 I did not have time to look into this project during the break because I was spending time on my break.
...
int main(int argc, const char* argv[]) {
  FILE* fadd = fopen("/Users/sydnienguyen/Desktop/CPSC 351- Operating Systems/Virtual Memory Manager/Virtual Memory Manager/addresses.txt", "r");    // open file addresses.txt  (contains the logical addresses)
  if (fadd == NULL) { fprintf(stderr, "Could not open file: 'addresses.txt'\n");  exit(FILE_ERROR);  }

  FILE* fcorr = fopen("/Users/sydnienguyen/Desktop/CPSC 351- Operating Systems/Virtual Memory Manager/Virtual Memory Manager/correct.txt", "r");     // contains the logical and physical address, and its value
